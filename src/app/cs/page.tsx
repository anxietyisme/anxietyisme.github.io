...
export const metadata: Metadata = {
  ...
  description: "Algorithms, data structures, systems programming, and tech insights.",
};

export default function CSIndexPage() {
  const notes = getNotes("cs");

  return (
    <div className="px-6 py-12">
      <div className="mb-12">
        <h1 className="text-3xl font-normal mb-4">Computer Science</h1>
        <div className="text-sm text-muted space-y-1">
          <p><strong>Focus:</strong> Algorithms, Systems Programming, Architecture</p>
      ...
      {notes.length > 0 ? (
        ...
        <p className="text-sm text-muted">No CS notes yet.</p>
      )}
    </div>
  );
}
