...
export const metadata: Metadata = {
  title: "Physics",
  description: "Deep-dives into quantum mechanics, classical mechanics, electrodynamics, and more.",
};

export default function PhysicsIndexPage() {
  const notes = getNotes("physics");

  return (
    <div className="px-6 py-12">
      <div className="mb-12">
        <h1 className="text-3xl font-normal mb-4">Physics</h1>
        <div className="text-sm text-muted space-y-1">
          <p><strong>Focus:</strong> Quantum Mechanics, Classical Mechanics, Electrodynamics</p>
          <p><strong>Level:</strong> Advanced Undergraduate</p>
        </div>
      </div>
      ...
      {notes.length > 0 ? (
        ...
        <p className="text-sm text-muted">No physics notes yet.</p>
      )}
    </div>
  );
}
